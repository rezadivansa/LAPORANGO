<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(.https://statics.indozone.news/local/623ad6af50607.jpg); background-size: cover;">
              ...
              <li>
                  <div class="user-view">
                      <div class="background">
                          <img src="https://statics.indozone.news/local/623ad6af50607.jpg">
                      </div>
											<div style="background: url('https://statics.indozone.news/local/623ad6af50607.jpg'); background-size: cover; background-repeat: no-repeat; background-position: center; padding: 20px; border-radius: 10px;">
  <h3 class="white-text" style="text-align:center"><b>Dashboard</b></h3>
  <div class="row">
    ...
  </div>
</div>
